...
public class Infos implements Serializable {
    ...
    public static final String HDFS_DEM3_YOUNG = "hdfs://young:9000/user/raw_data/dem3/";
    public static final String HDFS_DEM3_RIPOUX = "hdfs://ripoux:9000/user/raw_data/dem3/";
